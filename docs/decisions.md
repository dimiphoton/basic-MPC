...
| 2026-09-11 | Leçon : schémas générés + notebooks qui appellent `src/` | Recopier Kalman dans les `.ipynb` ; slides RH avec ρ | Les carnets explorent ; le filtre reste testé dans `src/`. |
